...
int main(int argc, char** argv) {
    ...
    unsigned int    plyrScr, //Score of the Player
                    ...
                    round;   //Counter for the Round
    int             rndScr,  //Round Score
                    maxScr;  //Max Score in a Game of Cribbage
    ...
    //"Shuffle" the Cards
        ...
        switch (uGoFrst) {
            ...
            case true: {
                ...
                for (unsigned short myTurn=1;myTurn<=PL_HAND;myTurn++){
                    ...
                    switch (myTurn) {
                        case 1: {
                            cout<<"first response"<<endl;
                            break;
                        }case 2: {
                            cout<<"second response"<<endl;
                            break;
                        }case 3: {
                            cout<<"third response"<<endl;
                            break;
                        }case 4: {
                            cout<<"fourth response"<<endl;
                            break;
                        }
                    }
        ...
        plyrScr=plyrScr+1;
        cout<<"Score: "<<plyrScr<<endl;
        cout<<"round: "<<round<<endl;
        
    }while (plyrScr<maxScr&&cmpScr<maxScr);
