...
int main(int argc, char** argv) {
    ...
    string crdDeck, //File to Pull Information From
           ...
           slct2;        //Second Card Selected by Player to Put in Crib
    ...
    do {
        do{
            ...
            if (slct1!=card1&&slct1!=card2&&slct1!=card3&&slct1!=card4&&slct1!=card5&&slct1!=card6){
                cout<<"Come on! No cheating!"<<endl<<endl;
            }
        //If Input is Invalid, Restart Loop    
        }while(slct1!=card1&&slct1!=card2&&slct1!=card3&&slct1!=card4&&slct1!=card5&&slct1!=card6);
        ...
        //Test to see if Input is Valid
        //Custom Message for Invalid Input  
        if (slct2!=card1&&slct2!=card2&&slct2!=card3&&slct2!=card4&&slct2!=card5&&slct2!=card6){
