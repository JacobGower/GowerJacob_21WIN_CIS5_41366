...
int main(int argc, char** argv) {
    ...
    float        *balance; //Savings Balance $'s  Parallel Array
    int             *year, //Year counter  Parallel Array
                   *dYear; //Year date  Parallel Array
    
    //Initialize Variables
    balance=new float[NYEARS];//Dynamic Memory Allocation with Pointers
    year=new int[NYEARS];     //Dynamic Memory Allocation with Pointers
    dYear=new int[NYEARS];    //Dynamic Memory Allocation with Pointers
